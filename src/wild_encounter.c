...
u8 ChooseWildMonIndex_WaterRock(void)
{
    ...
    if (rand < ENCOUNTER_CHANCE_WATER_MONS_SLOT_0)
        ...
        wildMonIndex = 3;
    else if (rand >= ENCOUNTER_CHANCE_WATER_MONS_SLOT_2 && rand < ENCOUNTER_CHANCE_WATER_MONS_SLOT_4)
        wildMonIndex = 4;
    else if (rand >= ENCOUNTER_CHANCE_WATER_MONS_SLOT_2 && rand < ENCOUNTER_CHANCE_WATER_MONS_SLOT_5)
        wildMonIndex = 5;
    else
        wildMonIndex = 6;
