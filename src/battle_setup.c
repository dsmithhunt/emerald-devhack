...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_JAMES] = REMATCH(TRAINER_PETALBURG_JAMES, TRAINER_PETALBURG_ELI, TRAINER_PETALBURG_NOAH, TRAINER_PETALBURG_CODY, TRAINER_PETALBURG_AIDEN, MAP_PETALBURG_WOODS),
    ...
    [REMATCH_WALLY_VR] = REMATCH(TRAINER_WALLY_MAUVILLE_TEPIG, TRAINER_WALLY_MAUVILLE_SOBBLE, TRAINER_WALLY_VR_4, TRAINER_WALLY_VR_5, TRAINER_WALLY_VR_5, MAP_VICTORY_ROAD_1F),
    [REMATCH_ROXANNE] = REMATCH(TRAINER_SIERRA, TRAINER_ROXANNE_2, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, TRAINER_ROXANNE_5, MAP_RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BRAWLY, TRAINER_BRAWLY_2, TRAINER_BRAWLY_3, TRAINER_BRAWLY_4, TRAINER_BRAWLY_5, MAP_DEWFORD_TOWN),
