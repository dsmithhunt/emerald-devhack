...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_FARAWAY_ISLAND,             MAPSEC_ROUTE_105},
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_EVER_GRANDE_CITY] = {MAP_GROUP(MAP_EVER_GRANDE_CITY), MAP_NUM(MAP_EVER_GRANDE_CITY), HEAL_LOCATION_BATTLE_FRONTIER_OUTSIDE_EAST},
...
u32 FilterFlyDestination(struct RegionMap* regionMap)
{
    ...
    case MAPSEC_EVER_GRANDE_CITY:
        return (FlagGet(FLAG_LANDMARK_POKEMON_LEAGUE) && regionMap->posWithinMapSec == 0 ? HEAL_LOCATION_EVER_GRANDE_CITY_POKEMON_LEAGUE : HEAL_LOCATION_BATTLE_FRONTIER_OUTSIDE_EAST);
    default:
