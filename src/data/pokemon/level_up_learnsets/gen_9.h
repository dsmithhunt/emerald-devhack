...
static const struct LevelUpMove sMoltinLevelUpLearnset[] = {
...
static const struct LevelUpMove sChesnaughtHoennLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SPIKY_SHIELD),
    LEVEL_UP_MOVE( 1, MOVE_FEINT),
    LEVEL_UP_MOVE( 1, MOVE_HAMMER_ARM),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
