...
static const struct FormChange sDeoxysFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_BEFORE_MOVE,          SPECIES_DEOXYS_DEFENSE, MOVE_PROTECT,        ABILITY_STANCE_CHANGE},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_PRIORITY,          SPECIES_DEOXYS_SPEED,   0,  ABILITY_STANCE_CHANGE},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_CATEGORY, SPECIES_DEOXYS_NORMAL,  DAMAGE_CATEGORY_PHYSICAL, ABILITY_STANCE_CHANGE},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_CATEGORY, SPECIES_DEOXYS_ATTACK,  DAMAGE_CATEGORY_SPECIAL,  ABILITY_STANCE_CHANGE},
