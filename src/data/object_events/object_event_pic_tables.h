...
static const struct SpriteFrameImage sPicTable_SalesRep[] = {
    overworld_ascending_frames(gObjectEventPic_SalesRep, 2, 4),
};
...
static const struct SpriteFrameImage sPicTable_TriathleteF[] = {
    overworld_ascending_frames(gObjectEventPic_TriathleteF, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Sierra[] = {
    overworld_ascending_frames(gObjectEventPic_Sierra, 2, 4),
};
