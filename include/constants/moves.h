...
// Custom Moves
#define MOVE_DESERT_STRIKE (MOVES_COUNT_GEN9 + 0)
#define MOVE_PINPOINT_STRIKE (MOVES_COUNT_GEN9 + 1)
#define MOVE_BAUBLE_BOBBLE (MOVES_COUNT_GEN9 + 2)

#define MOVES_COUNT_CUSTOM 3

#define MOVES_COUNT         (MOVES_COUNT_GEN9 + MOVES_COUNT_CUSTOM + 1)
